...
export const DriverDetails: FC<DriverDetailsProps> = ({ driverId }) => {
	...
	return (
		<>
			{infoInView && (
				<section
					className='fixed inset-0 top-[9svh] z-50 driver-details-card bg-white text-white flex flex-col mx-auto rounded-3xl mb-[11svh]'
					style={{ width: "95vw" }}
				>
					<div>
						<div>
					...
					<div className='w-full flex flex-col pt-4 items-center'>
